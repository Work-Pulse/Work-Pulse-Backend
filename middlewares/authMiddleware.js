...
firebaseAdmin.initializeApp({
  credential: firebaseAdmin.credential.cert(path.join('D:', 'Educational Projects', 'Work Pulse', 'Security Key', 'firebase-service-account.json')), // Absolute path to the service account JSON
});
